...
class Home extends Component {
  ...
  render() {
    const { ruangDirektorat } = this.state.form;
    const {
      photoShow,
      photoSuratDinas,
      FromDate,
    ...
    for (let index = 0; index < columns.length; index++) {
      if (
        columns[index].headerName === 'Nama' ||
        columns[index].headerName === 'Unit Kerja' ||
        columns[index].headerName === 'Keterangan Kegiatan Acara' ||
        columns[index].headerName === 'Ruangan' ||
        columns[index].headerName === 'Tanggal Mulai' ||
        columns[index].headerName === 'Email' ||
        columns[index].headerName === 'Status'
      ) {
    ...
    for (let index = 0; index < arraykosong.length; index++) {
      ...
      if (arraykosong[index] === 'Tu. Dirjen') {
        ...
        arraykosong[index] === 'Neglected Disease (Penyakit Tropis Terabaikan)'
      ) {
        ...
        arraykosong[index] === 'Diabetes Melitus dan Gangguan Metabolik'
      ) {
        ...
        arraykosong[index] === 'Pengelolaan Laboratorium Kesehatan Masyarakat'
      ) {
        ...
        <Container>
          ...
          <div className='mt-5 mb-5'>
            {ruangDirektorat === 'Sekertariat P2P' ? (
              <div>
                <Row>
                  <Col>Total Unit kerja Tu. Dirjen :</Col>
                  <Col>{arrayTuDirjen.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Tu.sesditjen :</Col>
                  <Col>{arrayTuSesDitJen.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Subag Adum Sekertariat P2P :</Col>
                  <Col>{arraySubagAdum.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Program dan Informasi :</Col>
                  <Col>{arrayProgramdanInforma.length}</Col>
                </Row>
                <Row>
                  <Col>
                    Total Unit kerja Hukum, Organisasi dan Hubungan Masyarakat :
                  </Col>
                  <Col>{arrayHukum.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Keuangan dan BMN :</Col>
                  <Col>{arrayKeuangandanBMN.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Kepegawaian dan Umum :</Col>
                  <Col>{arrayKepegdanUmum.length}</Col>
                </Row>
              </div>
            ) : (
              ''
            ...
            {ruangDirektorat === 'P2PM' ? (
              <div>
                <Row>
                  <Col>Total Unit kerja Subag Adum P2PM :</Col>
                  <Col>{arraySubagAdumP2PM.length}</Col>
                </Row>
                <Row>
                  <Col>
                    Total Unit kerja Turbeckulosis dan infeksisaluran pernapasan
                    akut (ISPA) :
                  </Col>
                  <Col>{arrayISPA.length}</Col>
                </Row>
                <Row>
                  <Col>
                ...
                <Row>
                  ...
                  <Col>{arrayNeglected.length}</Col>
                </Row>
                <Row>
                  <Col>
                    Total Unit kerja Zoonosis dan Penyakit Akibat Gigitan Hewan
                    Berbisa dan Tanaman Beracun :
                  </Col>
                  <Col>{arrayZoonosis.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Penyakit Tular Vektor :</Col>
                  <Col>{arrayPenyakitTular.length}</Col>
                </Row>
              </div>
            ) : (
              ''
            ...
            {ruangDirektorat === 'Pengelolaan  Imunisasi' ? (
              <div>
                <Row>
                  <Col>Total Unit kerja Subag Adum Pengelolaan Imunisasi :</Col>
                  <Col>{arraySubagAdumPengelolaan.length}</Col>
                </Row>
                <Row>
                  <Col>
                    Total Unit kerja Imunisasi Dasar dan Anak Usia di bawah dua
                    tahun (Baduta) :
                  </Col>
                  <Col>{arrayImunisasiBaduta.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Imunisasi Tambahan Dan Khusus :</Col>
                  <Col>{arrayImunisasiTambahan.length}</Col>
                </Row>
                <Row>
                  <Col>
                  ...
                  <Col>{arrayImunisasiWanitaUsiaSubur.length}</Col>
                </Row>
                <Row>
                  <Col>
                  ...
                  <Col>{arrayImunisasiUsiaSekolah.length}</Col>
                </Row>
              </div>
            ) : (
              ''
            ...
            {ruangDirektorat === 'P2PTM' ? (
              <div>
                <Row>
                  <Col>Total Unit kerja Subag Adum P2PTM :</Col>
                  <Col>{arraySubagAdump2ptm.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Gangguan Indra Dan Funsional :</Col>
                  <Col>{arrayGangguanIndra.length}</Col>
                </Row>
                <Row>
                  <Col>
                    Total Unit kerja Diabetes Melitus dan Gangguan Metabolik :
                  </Col>
                  <Col>{arrayDiabetesMilitus.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Jantung Dan Pembulu Darah :</Col>
                  <Col>{arrayJantungdanPembuludarah.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Kangker dan Kelainan Darah :</Col>
                  <Col>{arrayKangerdanKelainanDarah.length}</Col>
                </Row>
                <Row>
                  <Col>
                    Total Unit kerja Paru Kronik dan Gangguan Imunologi :
                  </Col>
                  <Col>{arrayParuKroni.length}</Col>
                </Row>
              </div>
            ) : (
              ''
            ...
            {ruangDirektorat === 'Penyehatan Lingkungan (PL)' ? (
              <div>
                <Row>
                  <Col>Total Unit kerja Subag Adum PL :</Col>
                  <Col>{arraySubagAdumPL.length}</Col>
                </Row>
                <Row>
                  <Col>
                    Total Unit kerja Penyehatan Air dan Sanitasi Dasar :
                  </Col>
                  <Col>{arrayPenyehatanAir.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Penyehatan Pangan :</Col>
                  <Col>{arrayPenyehatanPangan.length}</Col>
                </Row>
                <Row>
                  <Col>
                    Total Unit kerja Penyehatan Udara,Tanah dan Kawasan :
                  </Col>
                  <Col>{arrayPenyehatanUdara.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Pengamanan Limbah dan Radiasi :</Col>
                  <Col>{arrayPengamananLimbah.length}</Col>
                </Row>
                <Row>
                  <Col>
                    Total Unit kerja Adaptasi Perubahan Iklim dan Kebencanaan
                    Lingkungan :
                  </Col>
                  <Col>{arrayAdaptasiPerubahan.length}</Col>
                </Row>
              </div>
            ) : (
              ''
            ...
            {ruangDirektorat === 'SUKARKES' ? (
              <div>
                <Row>
                  <Col>Total Unit kerja Subag Adum SUKARKES :</Col>
                  <Col>{arraySubagAdumSuarkes.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Kekarantinaan Kesehatan :</Col>
                  <Col>{arrayKekarantinaankesehatan.length}</Col>
                </Row>
                <Row>
                  <Col>
                  ...
                  <Col>{arrayPengelolaanLaboratorium.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Pengendalian Vektor :</Col>
                  <Col>{arrayPengendalianVetor.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Penyakit Infeksi Emerging :</Col>
                  <Col>{arrayPenyakitInfeksi.length}</Col>
                </Row>
                <Row>
                  <Col>Total Unit kerja Surveilans :</Col>
                  <Col>{arraySurveilans.length}</Col>
                </Row>
              </div>
            ) : (
              ''
          ...
          <div>
            <Row>
              <Col>Total Per Direktorat:</Col>
              <Col>{arraydirektorat.length}</Col>
            </Row>
          </div>
